...
def go_settings_tab(header_ui):
    ...
    def inner_input_feishu_webhook(x):
            ...
            with gr.Tab("推送"):
                with gr.Column(elem_classes="btb-card btb-layout-card"):
                    ...
                    feishu_webhook_ui = gr.Textbox(
                        ...
                        label="飞书 Webhook URL｜输入完成后，回车键保存",
                        interactive=True,
                        info="例如: https://open.feishu.cn/open-apis/bot/v2/hook/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
                    )
    ...
    def load_go_settings_configs():
        ...
        return [
            ...
            gr.update(value=ConfigDB.get("feishuWebhook") or ""),
